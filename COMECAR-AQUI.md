...
1. Passos 1 a 4 do [README](README.md). Instalar, instalar os comandos, e deixar que ele te
   entreviste: `/cerebro entrevista` pergunta quem és uma coisa de cada vez e preenche o teu
   contexto por ti.
